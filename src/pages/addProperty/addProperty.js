...
const AddProperty = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="min-h-max max-w-screen flex flex-col justify-center items-center"
        id="contactUs"
      >
        <div
          className="md:w-[70vw] rounded-md my-5"
          style={{
            boxShadow:
          ...
          <form onSubmit={(e) => onSubmitHandler(e)}>
            <div className="w-full flex flex-col items-center">
              ...
              <div className="w-[60vw] flex flex-row justify-center my-5">
                <Button
                  label={
                    buttonLoader ? <ButtonLoader color="#DE5C0B" /> : "Submit"
                  }
                  type="submit"
                />
              </div>
